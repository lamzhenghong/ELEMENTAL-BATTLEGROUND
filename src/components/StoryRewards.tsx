  ...
  return (
    <div className="fixed inset-0 z-55 bg-slate-950/90 backdrop-blur-md flex items-center justify-center p-4 select-none">
      <motion.div
        ...
        className="bg-slate-900 border-2 border-amber-500/40 rounded-2xl p-5 md:p-6 max-w-md w-full text-center flex flex-col max-h-[90vh] shadow-[0_0_60px_rgba(251,191,36,0.15)] relative overflow-hidden"
      >
        {/* Glow Effects */}
        ...
        <div className="flex-1 overflow-y-auto space-y-4 md:space-y-6 pr-1 scrollbar-thin mb-4">
          ...
          <div className="w-16 h-16 bg-amber-500/10 rounded-full flex items-center justify-center border border-amber-400 mx-auto animate-bounce mt-2">
        ...
        <button
          onClick={onProceed}
          className="w-full p-3.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-xs uppercase tracking-widest rounded-xl transition-all cursor-pointer shadow-lg shadow-amber-500/10 hover:scale-[1.02] active:scale-95 shrink-0"
        >
          Confirm & Proceed
        </button>
      </motion.div>
